...
class javaHTTPServer extends Thread {
...
public javaHTTPServer(Socket client) {
...
public void sendResponse (int statusCode, String responseString, boolean isFile) throws Exception {
    ...
    if (isFile) {
        ...
        responseString = javaHTTPServer.HTML_START + responseString + javaHTTPServer.HTML_END;
...
public static void main (String args[]) throws Exception {
    ...
    while(true) {
        ...
        (new javaHTTPServer(connected)).start();
    }
}
}