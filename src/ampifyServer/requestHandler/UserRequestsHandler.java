...
import static AMPIFY_server.src.commonPackages.responses.ResponseCode.*;

import AMPIFY_server.src.commonPackages.requests.auth.SignupRequest;
import AMPIFY_server.src.commonPackages.requests.group.LeaveGroup;
...
import AMPIFY_server.src.commonPackages.responses.user.*;
